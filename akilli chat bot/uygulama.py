...
def veritabanini_yukle():
    with open('C:\\Users\\zeybit\\Desktop\\akilli chat bot\\veritabani.json', 'r') as dosya:#dosyanızın konumuna göre değiştirin
        return json.load(dosya)

def veritabanina_yaz(veriler):
    with open('C:\\Users\\zeybit\\Desktop\\akilli chat bot\\veritabani.json', 'w') as dosya:
...
def chat_bot():
    ...
    while True:
        soru = input("Siz: ")
        if soru == 'çik':#eğer kullanıcı çik derse döngü sonlanır
            break
